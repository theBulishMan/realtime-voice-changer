...
if /i "%MODE%"=="real" (
  ...
  set "RVC_TTS_INFER_WORKERS=2"
  set "RVC_TTS_MODEL_REPLICAS=2"
  set "RVC_TTS_NON_STREAMING_MODE=1"
  set "RVC_TTS_MAX_NEW_TOKENS_MIN=160"
  set "RVC_TTS_MAX_NEW_TOKENS_CAP=640"
  set "RVC_TTS_TOKENS_PER_CHAR=7"
  set "RVC_ASR_BACKEND=qwen3"
  set "RVC_QWEN_ASR_MODEL_ID=Qwen/Qwen3-ASR-0.6B"
  set "RVC_QWEN_ASR_MAX_NEW_TOKENS=96"
  set "RVC_QWEN_ASR_MAX_INFERENCE_BATCH_SIZE=2"
